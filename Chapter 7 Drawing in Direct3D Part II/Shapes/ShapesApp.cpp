...
private:
	...
	void BuildConstantsBasedRootSignature();
...
bool ShapesApp::Initialize()
{
    ...
    BuildRootSignature();
	//BuildConstantsBasedRootSignature();
...
void ShapesApp::BuildConstantsBasedRootSignature()
{
	// Root parameter can be a table, root descriptor or root constants.
	CD3DX12_ROOT_PARAMETER slotRootParameter[2];

	CD3DX12_DESCRIPTOR_RANGE cbvTable0;
	cbvTable0.Init(D3D12_DESCRIPTOR_RANGE_TYPE_CBV, 0, 0);

	slotRootParameter[0].InitAsDescriptorTable(1, &cbvTable0);

	// Create root CBVs.
	slotRootParameter[1].InitAsConstants(1, 16);
...
void ShapesApp::BuildShapeGeometry()
{
	...
	GeometryGenerator::MeshData skull = geoGen.LoadFromFile("Skull.txt"); //geoGen.CreateSphere(0.5f, 20, 20); 
